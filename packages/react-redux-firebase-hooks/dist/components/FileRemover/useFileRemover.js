              ...
              setState(function(currentState) {
                return _objectSpread(_objectSpread({}, currentState), {}, {
                  removingFileList: function() {
                    const updatedFiles = _toConsumableArray(currentState.removingFileList);
